...
export const create  = (data: CreateVeterinarioInput) => repo.createVeterinario(data);
export const update  = (id: number, data: UpdateVeterinarioInput) => repo.updateVeterinario(id, data);

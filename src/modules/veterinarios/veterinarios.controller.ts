...
export const getById = async (req: Request, res: Response) => {
  try {
    ...
    if (!item) return fail(res, "Veterinario no encontrado", 404);
    return ok(res, item);
  } catch (e) { return serverError(res, e); }
};
...
export const create = async (req: Request, res: Response) => {
  try {
    ...
    return created(res, await svc.create(data), "Veterinario creado");
  } catch (e: any) {
...
export const update = async (req: Request, res: Response) => {
  try {
    ...
    if (!item) return fail(res, "Veterinario no encontrado", 404);
    return ok(res, item, "Veterinario actualizado");
  } catch (e: any) {
    if (e?.errors) return fail(res, e.errors[0]?.message ?? "Datos inválidos");
    return serverError(res, e);
  }
...
export const remove = async (req: Request, res: Response) => {
  try {
    ...
    if (!item) return fail(res, "Veterinario no encontrado", 404);
    return ok(res, item, "Veterinario desactivado");
  } catch (e) { return serverError(res, e); }
};
